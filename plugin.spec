              ...
              options:
                  mirror:
                      ...
                      help: |
                          ...
                          Note: Currently used only for splitstack scale up/down.
                  ...
                  version:
                      ...
                      help: |
                          ...
                          Note: Currently used only for splitstack scale up/down. It is not mandatory,
                          if not provided plugin will use value from automatic version discovery
                      choices:
                        - "7"
                        - "8"
                        - "9"
